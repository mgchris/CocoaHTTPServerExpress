...
- (BOOL)supportsMethod:(NSString *)method atPath:(NSString *)path {
    BOOL supported = [[HTTPExpressManager defaultManager] supportedAllMethods];
    if( supported == NO ) { // Check the evals blocks
        ...
        supported = [[HTTPExpressManager defaultManager] supportsMethod:testMessage];
    }
    return supported;
}
